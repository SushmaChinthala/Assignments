...
public class student {
    public static void main(String args[])
    {
        ...
        a1=(m1+h1+c1)/3;
        System.out.println("first student averafge marks"+a1);
        a2=(m2+h2+c2)/3;
        System.out.println("second student averafge marks"+a2);
        a3=(m3+h3+c3)/3;
        System.out.println("third student averafge marks"+a3);
        st1=m1+m2+m3;
        System.out.println("maths totral marks"+st1);
        st2=h1+h2+h3;
        System.out.println("history totral marks"+st2);
        st3=c1+c2+c3;
        System.out.println("chemistry totral marks"+st3);
        sa1=(m1+m2+m3)/3;
        System.out.println("maths average marks"+sa1);
        sa2=(h1+h2+h3)/3;
        System.out.println("history average marks"+sa2);
        sa3=(c1+c2+c3)/3;
        System.out.println("maths totral marks"+sa3);
