...
public class OrderController 
{
	private OrderService service;
	   ...
	   public OrderController(OrderService service) {
	    ...
	    public OrderDetails retrieveUser(@PathVariable int id )
	    {
	    ...
	    public void  UpadateOrderDetails(@PathVariable int id, @RequestBody OrderDetails order)
	    {
	        service.updateById(id, order);
	    }
